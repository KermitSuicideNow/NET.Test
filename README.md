...
Si bien esta solución está creada con Visual Studio 2015, se puede abrir perfectamente en Visual Studio 2010 y posteriores.

## Paquetes Nuget ##

Puedes descargar los paquetes Nuget de **OpenInvoicePeru** desde la página oficial de [Nuget](https://www.nuget.org/packages/OpenInvoicePeru.DataTransfersObjects/).
